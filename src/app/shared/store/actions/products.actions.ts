...
export const fetchProducts = createAction('[Products] fetchProducts',props<{pageSize?:number,startIndex:number,endIndex:number}>());
export const fetchProductsSuccess = createAction('[Products] fetchProductsSuccess', props<{ products: IProduct[],pageSize:number,startIndex:number,endIndex:number}>());
